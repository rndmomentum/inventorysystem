        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page" style="color:green;">List Location</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="float-end mb-3">
                        <a href="{{ url('information/location/create') }}" class="btn btn-outline-success"><i class="fas fa-plus"></i> Create Location</a>
                    </div>
                </div>
            </div>
            @if(session('success'))
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        @foreach ($information as $value)
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="remove{{ $value->information_id }}" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-body">
                                        Are you sure to remove from location?
                                    </div>
