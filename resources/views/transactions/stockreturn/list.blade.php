        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page" style="color:green;">List Stock Return</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="float-end mb-3">
                        <a href="{{ url('transaction/stockreturn/create') }}" class="btn btn-outline-success"><i class="fas fa-plus"></i> Create Stock In</a>
                    </div>
                </div>
            </div>
            @if(session('success'))
