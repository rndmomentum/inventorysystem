...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page" style="color:green;">Create Stock In</li>
                </ol>
            </nav>
        </div>
        @if(session('success'))
        ...
        <div class="col-md-12 mt-3">
            <h4>Stock In</h4>
            <hr>
            <form action="{{ url('transaction/stockin/store') }}" enctype="multipart/form-data" method="POST" class="needs-validation" novalidate>
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-3">
